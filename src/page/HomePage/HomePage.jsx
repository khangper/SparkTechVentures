...
export default function HomePage() {
  ...
  const handleProductClick = (id) => {
    if (mode === "compare") {
      navigate(`/compare/${productId}`, { state: { secondProduct: id, mode: "selected"} });
    } else {
      navigate(`/main?id=${id}`);
    }
  };        
        ...
        <div className="Home-container">
          ...
          <div className="container PageList">
            <div className="row justify-content-center">
              ...
              <Link to="/AllProduct" className="col-4 ml-80px">
                View all
              </Link>
            </div>
          </div>
          ...
          <div className="Intro">
            ...
            <div className="intro-flex-colum">
              <div className="Intro-rectangle-2"></div>

              <div className="container">
                <div className="row">
                  <div className="Intro-spann col-6">
                    <span className="Intro-call-for-quote">
                      Call for a Quote
                    </span>
                  ...
                  <div className="Intro-rectangle-3 col-6">
                    <button className="Intro-button-4">
                      <span className="Intro-free-quote-5">
