...
const Profile = () => {
  ...
  const userData = {
    ...
    "picture": "https://firebasestorage.googleapis.com/v0/b/marinepath-56521.appspot.com/o/male.png?alt=media&token=6f3a8425-e611-4f17-b690-08fd7b465219",
    "role": "LESSOR",
    "storeName": null
  };
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="flex-1 p-6 space-y-6 bg-gray-50 rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-700">{formatDate(userData.dateOfBirth)}</p>
            </div>
          </div>
        </div>
        ...
        {userData.storeId && (
          <div className="mt-6">
            <h2 className="text-xl font-semibold text-gray-800 border-b pb-2">Store Information</h2>
            ...
            {userData.storeName && (
              <div className="mt-4 flex items-center space-x-4">
                <div>
                  ...
                  <p className="text-gray-700">{userData.storeName || "Not updated yet"}</p>
                </div>
              </div>
            )}
          </div>
