...
export default function ContactUS() {
    ...
    return (
      ...
      <div className="CU-rectangle-5">
          ...
          <div className="CU-frame-7">
            ...
            <div className="CU-frame-8">
              ...
              <div className="CU-frame-a">
                <span className="CU-open-office-hours">Open Office Hours</span>
                    ...
                    <div className='row'>
                        <div className='col-6'>
                            ...
                            <div className='CU-end-from CU-end-from1'>
                             ...
                             <div className="input-group mb-3">
                              <input type="text" className="form-control" placeholder="Message" aria-label="Username" aria-describedby="basic-addon1"/>
                             </div>
                            </div>
                        </div>
                        <div className='col-6'>
        ...
        <div className={`collapse ${isOpen1 ? 'show' : ''}`} id="collapseExample1">
      ...
      <div className="CU-end-informa">
        ...
        <div className={`collapse ${isOpen2 ? 'show' : ''}`} id="collapseExample2">
          <div className="card card-body content">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sapien, dignissim tristique tellus sed faucibus nullam. Tincidunt mauris ut quam sed mauris proin feugiat.
          </div>
        </div>
      ...
      <div className="CU-end-informa">
        ...
        <div className={`collapse ${isOpen3 ? 'show' : ''}`} id="collapseExample3">
          <div className="card card-body content">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sapien, dignissim tristique tellus sed faucibus nullam. Tincidunt mauris ut quam sed mauris proin feugiat.
          </div>
        </div>
      ...
      <div className="CU-end-informa">
        ...
        <div className={`collapse ${isOpen4 ? 'show' : ''}`} id="collapseExample4">
          <div className="card card-body content">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sapien, dignissim tristique tellus sed faucibus nullam. Tincidunt mauris ut quam sed mauris proin feugiat.
          </div>
        </div>
      ...
      <div className="CU-end-informa">
        ...
        <div className={`collapse ${isOpen5 ? 'show' : ''}`} id="collapseExample5">
          <div className="card card-body content">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sapien, dignissim tristique tellus sed faucibus nullam. Tincidunt mauris ut quam sed mauris proin feugiat.
          </div>
        </div>
